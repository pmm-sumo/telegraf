...
const deprecationMsg = "E! Error: this Riemann output plugin will be deprecated in a future release, see https://github.com/pmalek-sumo/telegraf/issues/1878 for more details & discussion."
